package com.xdivision.techcasts.ui.theme
...
@SuppressLint("NewApi")
@Composable
fun TechcastsTheme(darkTheme: Boolean = isSystemInDarkTheme(), content: @Composable() () -> Unit) {
    ...
    val colors = when {
        ...
        isDynamicColorAvailable && !darkTheme -> isDynamicColorAvailable(context)
